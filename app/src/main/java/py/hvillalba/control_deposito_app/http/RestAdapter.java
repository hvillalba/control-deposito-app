package py.hvillalba.control_deposito_app.http;
...
import py.hvillalba.control_deposito_app.util.Constan;
...
public class RestAdapter {
    ...
    public static Retrofit  getClient(String ip) {
        ...
        //String BASE_URL = Constan.URL_PATH;
        String BASE_URL = "http://" + ip + ":8080/deposito-api/api/";
